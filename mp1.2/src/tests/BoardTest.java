...
public class BoardTest {
	...
	public void testBoardCopy() {
		...
		myCopy.updateMove(0, 0, 6, 6);
		myCopy.updateMove(0, 2, 2, 6);
		myCopy.updateMove(2, 0, 3, 6);
		assertTrue(board.havePiece(0,0) != null);
		assertTrue(myCopy.havePiece(0,0) == null);
		assertTrue(myCopy.havePiece(6,6) != null);
		assertTrue(board.havePiece(0,2) != null);
		assertTrue(myCopy.havePiece(0,2) == null);
		assertTrue(board.havePiece(2,0) != null);
		assertTrue(myCopy.havePiece(2,0) == null);
	}
	...
	public void testfinalValidMove(){
		board = new Board(true);
		assertTrue(board.finalValidMove(7, 5, 7, 1));
		board.clear();
		board.setPiece(0, 1, "King", true);
	...
	public void teststaleMate(){
		board = new Board(true);
		assertFalse(board.stalemate(false));
		assertFalse(board.stalemate(true));
		board.clear();
		board.setPiece(0, 0, "King", true);
		board.setPiece(2, 1, "Queen", false);
		board.setPiece(3, 3, "King", false);
		assertTrue(board.stalemate(true));
		assertTrue(board.havePiece(0,0) != null);
		assertTrue(board.havePiece(2,1) != null);
		assertTrue(board.havePiece(3,3) != null);
	}
