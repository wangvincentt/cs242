...
public class Bomb extends Piece {
	...
	public Piece copy(){
		Piece ret = new Bomb(this.getPosition().getFirst(), this.getPosition().getSecond(),this.getOwnership());
		ret.setOwnership(this.getOwnership());
		ImageIcon icon = new ImageIcon("images/"+( (getOwnership())? "Black" : "White" )+"/Bomb.png");
		setIcon(icon);
		return ret;
	}
