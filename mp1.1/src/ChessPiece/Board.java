...
public class Board extends JPanel {
	...
	public Board()
	{
		...
		board[2][0] = new Bomb(0,2,false);
		board[2][4] = new Stone(4,2,false);
		...
		board[5][7] = new Bomb(7,5,true);
		board[5][4] = new Stone(4,5,true);
	...
	public void updateMove(int x, int y, int targetX, int targetY){
		if(board[y][x]==null)
			return;
		if(board[y][x] instanceof Bomb && board[targetY][targetX]!=null){
